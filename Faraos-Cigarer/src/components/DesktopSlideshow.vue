  ...
  <div class="slideshow__wrapper" aria-label="Wrapper">
    <div class="slideshow" aria-label="Karrusel">
      <div v-show="currentIndex === 0" aria-label="1 ud af 6: karrusel">
        <img
          src="../assets/image/desktop_slideshow_1.webp"
          alt="Asterix bøger"
      ...
      <div v-show="currentIndex === 1" aria-label="2 ud af 6: karrusel">
        <img
          src="../assets/image/desktop_slideshow_2.webp"
      ...
      <div v-show="currentIndex === 2" aria-label="3 ud af 6: karrusel">
        <img
          src="../assets/image/desktop_slideshow_3.webp"
      ...
      <div v-show="currentIndex === 3" aria-label="4 ud af 6: karrusel">
        <img
          src="../assets/image/desktop_slideshow_4.webp"
      ...
      <div v-show="currentIndex === 4" aria-label="5 ud af 6: karrusel">
        <img
          src="../assets/image/desktop_slideshow_5.webp"
      ...
      <div v-show="currentIndex === 5" aria-label="6 ud af 6: karrusel">
        <img
          src="../assets/image/desktop_slideshow_6.webp"
