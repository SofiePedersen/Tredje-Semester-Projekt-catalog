...
<template>
    <nav class="breadcrumbs" aria-label="Navigations brødkrummer">
        ...
        <RouterLink class="breadcrumbs__text" to="/Butikker" aria-label="Navigation til oversigten over butikker">Butikker</RouterLink>
        <p class="breadcrumbs__text">></p>
        <RouterLink class="breadcrumbs__text" to="/Information" aria-label="Navigation til Odense butik">Odense</RouterLink>
    </nav>
